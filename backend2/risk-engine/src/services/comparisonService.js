...
exports.compareInfluencers = compareInfluencers;
const types_1 = require("../types");
const riskService_1 = require("./riskService");
/**
 * Compares two influencers and evaluates which one is a safer investment.
 */
function compareInfluencers(input) {
    const { influencerA, influencerB, campaignBudget } = input;
    const context = { campaignBudget };
    const metricsA = (0, riskService_1.analyzeInfluencerRisk)(influencerA, context);
    const metricsB = (0, riskService_1.analyzeInfluencerRisk)(influencerB, context);
